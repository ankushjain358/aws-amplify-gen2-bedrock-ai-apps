...
export const handler: Schema['generateInstagramCaptions']['functionHandler'] = async (event, context) => {
    ...
    const additionalInstructions = [
        ...
        "2. If the image is appropriate, generate captions and return the response in HTML format, so it can be displayed in the UI app."
    ];
    ...
    const bedrockResponse = data.outputs[0].text;
