...
export const handler: Schema['generateInstagramCaptions']['functionHandler'] = async (event, context) => {
    ...
    try {
        ...
        const additionalInstructions = [
            ...
            "2. If the image is suitable, generate captions and return the response in HTML format. Use an ordered or unordered list (with Tailwind CSS) to display the captions, so they can be shown in the UI app."
        ];
